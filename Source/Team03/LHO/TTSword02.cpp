...
void ATTSword02::MulticastThrowAway_Implementation ()
{
	...
	if (PickupComponent)
	{
		...
		(
			...
			this,
			&ATTSword02::EnablePickupCollision,
			1.0f,
			false
		);
	}
...
void ATTSword02::HandleOnPickUp ( ATTPlayerCharacter* InPickUpCharacter )
{
...
void ATTSword02::EnablePickupCollision()
{
	if (PickupComponent)
	{
